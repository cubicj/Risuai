export const languageKorean = {
    ...
    "help": {
        ...
        "customCSS": "스타일링을 위한 커스텀 CSS입니다. 문제가 발생하면 주요 보조키 + .으로 비활성화/활성화할 수 있습니다. 주요 보조키는 macOS에서 Command, 그 외 환경에서 Ctrl입니다.",
        "betaMobileGUI": "활성화되면 작은 화면(800px 미만)에서 베타 모바일 GUI를 사용합니다. 새로고침이 필요합니다.",
        "enableScrollToActiveChar": "활성화되면 단축키를 누르거나 캐릭터를 드래그하는 동안 주요 보조키를 누르면 현재 활성 캐릭터로 스크롤합니다. 주요 보조키는 macOS에서 Command, 그 외 환경에서 Ctrl입니다. 폴더가 닫혀있으면 자동으로 열립니다.",
        "useLegacyMacOSCtrlHotkeys": "활성화하면 저장된 Ctrl 단축키가 macOS에서 Command 대신 Control 키로 동작합니다. 일반적인 macOS 단축키 동작을 원하면 꺼두세요.",
        ...
        "hypaV3MaxMemoryTokensRatio": "메모리 토큰 비율의 추정 최댓값입니다. 현재 설정이 만드는 고정 프롬프트 오버헤드(프롬프트 템플릿, 캐릭터, 페르소나, 로어북 예산)와 HypaV3가 요약하지 않는 최근 채팅을 현재 채팅에서 실측해 뺀 값이며, 채팅 메시지가 쿼리 채팅 수보다 적으면 부족한 만큼 최대 응답 크기로 계산합니다. 정규식 스크립트, 트리거, 턴마다 달라지는 로어북 활성화는 포함하지 않습니다.",
    ...
    "highcontrast": "고대비",
    "quickPreset": "주요 보조키 + (프리셋 번호)로 프리셋을 빠르게 변경할 수 있습니다. 주요 보조키는 macOS에서 Command, 그 외 환경에서 Ctrl입니다.",
    ...
    "useLegacyMacOSCtrlHotkeys": "macOS에서 기존 Ctrl 단축키 사용",
    ...
    "hypaV3Settings": {
        ...
        "maxMemoryTokensRatioNoCharacter": "캐릭터를 선택하면 추정치가 표시됩니다.",
        ...
        "overheadBreakdownLabel": "컨텍스트 사용량 내역 (추정)",
        "overheadTotalLabel": "합계",
        "overheadItems": {
            "promptTemplate": "프롬프트 템플릿",
            "description": "캐릭터 설명",
            "persona": "페르소나",
            "authorNote": "작가의 말",
            "lorebook": "로어북 예산",
            "exampleMessages": "예시 대화",
            "postExtras": "후행 지시문",
            "slack": "안전 마진",
            "recentChats": "최근 채팅 (쿼리 채팅 수)",
        },
    },
    "hypaV3Modal": {
        "titleLabel": "HypaV3",
